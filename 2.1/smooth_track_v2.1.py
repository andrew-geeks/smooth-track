...
def Home(): #home_page
        ...
        Label(home,text='SmoothTrack_2.1',font=('Times','30','bold'),bg='SpringGreen2').place(x=300,y=10)
...
def infow(): #info_page
    ...
    Label(info,text='Version Number: 2.1',font=('Times','20'),bg='SpringGreen2').place(x=340,y=90)
    ...
    Label(info,text='Last Update: 24-06-2020',font=('Times','20'),bg='SpringGreen2').place(x=330,y=240)
    Label(info,text='Browser Type: FireFox',font=('Times','20'),bg='SpringGreen2').place(x=335,y=285)
